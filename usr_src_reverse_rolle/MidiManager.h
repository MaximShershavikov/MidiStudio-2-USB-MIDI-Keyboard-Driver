...
#define UP_ROLLE_POS 127

#define MOD_ROLLE_HEAD_1 0xe10e
#define MOD_ROLLE_HEAD_2 0xe00e

#define PITCH_BEND_ROLLE_HEAD_1 0xb10b
#define PITCH_BEND_ROLLE_HEAD_2 0xb00b
...
struct MIDI_INFO
{
    ...
    WORD *PtrBufferWord = (WORD*)ReadBuffer;
